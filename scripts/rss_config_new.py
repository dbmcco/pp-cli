...
REQUIRED FORMAT:
• **Headline**: Brief summary with specific impact. [Source: Publication](URL)

CRITICAL:
- Use markdown link format: [Source Name](full-url)
- Include the full source URL from the "Link:" field in the provided content
- Each bullet must have exactly one source citation in markdown format
...
REQUIRED FORMAT:
• **Headline**: Brief summary with location context. [Source Name](URL)

CRITICAL:
- Use markdown link format: [Source Name](full-url)
- Include full URL from "Link:" field in provided content
- Each bullet must have exactly one source citation in markdown format
...
REQUIRED FORMAT:
• **Tool/Project Name**: What it does and why it matters technically. [Source Name](URL)
...
REQUIRED FORMAT:
• **Discovery**: What was found, where, and what it reveals. [Source Name](URL)
...
REQUIRED FORMAT:
• **Research Finding**: What the study reveals about creative/intuitive processes. [Source Name](URL)
...
REQUIRED FORMAT:
• **Discovery/Development**: What was found and why it matters. [Source Name](URL)
...
REQUIRED FORMAT:
• **Vehicle/Technology**: What's new in design, engineering, or development. [Source Name](URL)
...
REQUIRED FORMAT:
• **Policy Development**: Impact and implications. [Source Name](URL)
...
REQUIRED FORMAT:
• **Story Title**: Why it matters technically or intellectually. [Source Name](URL)
...
REQUIRED FORMAT:
• **Composer/Event**: What's new and why it matters to contemporary music. [Source Name](URL)
